      ...
      <div className="max-w-[1400px] mx-auto px-7 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-[120px] items-center">
          <div className="reveal">
            <p className="inline-flex items-center gap-3.5 text-[13px] font-medium tracking-[0.35em] uppercase text-accent mb-8 before:content-[''] before:w-9 before:h-px before:bg-accent">
              Who We Are
            </p>
            <h2
            ...
            <p className="text-[19px] font-light leading-[1.85] text-charcoal mb-6 max-w-[520px]">
            ...
            <div className="font-serif text-[26px] font-light italic text-accent mt-12 pt-10 border-t border-sand max-w-[520px] leading-[1.4]">
            ...
            <div className="grid grid-cols-2 gap-[2px] bg-sand">
              {stats.map((s) => (
                <div key={s.label} className="bg-ink p-10 md:px-11 md:py-14">
                  <div className="font-serif text-[66px] md:text-[90px] font-light text-warm-white leading-[0.95] mb-5">
                    {s.num}
                  </div>
                  <div className="text-[15px] font-normal tracking-[0.14em] uppercase text-stone leading-[1.5]">
                    {s.label}
                  </div>
                </div>
              ))}
