      ...
      >
        <div style={{ padding: "32px 28px 40px" }}>
          <SheetHeader>
            ...
            {projectName && (
              <SheetDescription style={{ color: TAUPE, fontSize: 17, marginTop: 4 }}>
                {projectName}
              </SheetDescription>
            )}
          </SheetHeader>
          ...
          <section style={{ marginBottom: 36 }}>
            ...
            {loading ? (
              <div style={{ fontSize: 17, color: TAUPE }}>Loading…</div>
            ) : links.length === 0 ? (
              <div style={{ fontSize: 17, color: TAUPE, fontStyle: "italic" }}>No links yet.</div>
            ) : (
                ...
                {links.map((l) => (
                  ...
                  >
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 18, color: CREAM, fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        {l.label}
                      </div>
                      <a
                        href={l.url}
                        target="_blank"
                        rel="noreferrer"
                        style={{ display: "block", fontSize: 16, color: TAUPE, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}
                      >
                        {l.url}
                      </a>
                    </div>
          ...
          <section>
            ...
            {loading ? null : notes.length === 0 ? (
              <div style={{ fontSize: 17, color: TAUPE, fontStyle: "italic" }}>No notes yet.</div>
            ) : (
                ...
                {notes.map((n) => (
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                      <div style={{ flex: 1, fontSize: 18, color: CREAM, whiteSpace: "pre-wrap", lineHeight: 1.55 }}>
                        {n.body}
                      </div>
                      <button
                    ...
                    <div style={{ marginTop: 10, fontSize: 14, letterSpacing: "0.2em", textTransform: "uppercase", color: "hsl(40 10% 55%)" }}>
