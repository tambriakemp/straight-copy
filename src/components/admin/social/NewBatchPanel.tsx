// Starting a batch, in a side panel rather than a centred modal.
//
// Was a shadcn Dialog — the only one left on this tab, and the admin does not
// use them: every other "edit one thing" flow here is SidePanel, and a centred
// box over the queue hid the very posts you were adding to.
...
export default function NewBatchPanel({
  open, onClose, clientProjectId, onCreated,
}: {
  open: boolean;
  onClose: () => void;
  ...
  return (
    <SidePanel
      open={open}
      onClose={onClose}
      title="New social batch"
      subtitle="Written from this client's intake, brand kit and brand voice."
      width={470}
      footer={
