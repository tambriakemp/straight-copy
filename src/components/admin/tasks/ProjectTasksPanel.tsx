...
export default function ProjectTasksPanel({ clientProjectId }: Props) {
  ...
  // Not a fallback for realtime — realtime has not worked here since
  // 2026-06-11 (see the subscription below). This is the only thing that brings
  // the board up to date short of reloading the browser, which throws you back
  // to the client list.
