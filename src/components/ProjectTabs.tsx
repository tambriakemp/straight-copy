...
>(({ className, ...props }, ref) => (
  <TabsTrigger
    ref={ref}
    className={cn(
      "relative shrink-0 rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-[13px] sm:text-[14px] uppercase tracking-[0.25em] sm:tracking-[0.3em]",
