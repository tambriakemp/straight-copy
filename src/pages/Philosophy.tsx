      ...
      <div className="md:cursor-none">
        ...
        <section className="pt-[180px] pb-[100px] bg-ink flex flex-col justify-end px-8 md:px-[52px] relative overflow-hidden min-h-screen">
          <div
            ...
            style={{ fontSize: "clamp(182px, 22vw, 342px)", letterSpacing: "-0.02em" }}
          >
            Architect.
          </div>
          ...
          <p className="text-[13px] tracking-[0.35em] uppercase text-taupe mb-7 pl-6 animate-fade-up animate-fade-up-delay-1 relative">
            Our Philosophy
          </p>
          ...
          <div className="absolute bottom-12 right-8 md:right-[52px] flex flex-col items-center gap-3 animate-fade-up" style={{ animationDelay: "1s" }}>
            ...
            <span className="text-[11px] tracking-[0.3em] uppercase text-taupe [writing-mode:vertical-rl]">Scroll</span>
          </div>
        </section>
        ...
        <section className="bg-cream py-[140px] px-8 md:px-[52px] grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-[120px] items-center">
          <div className="reveal">
            ...
            <p className="text-[13px] tracking-[0.2em] uppercase text-taupe mt-8">— Cre8 Visions</p>
          </div>
          <div className="reveal reveal-delay-1">
            <p className="text-[13px] tracking-[0.35em] uppercase text-accent mb-6">Where We Come From</p>
            <p className="text-[17px] font-light leading-[1.95] text-charcoal mb-5">
            ...
            <p className="text-[17px] font-light leading-[1.95] text-charcoal">
        ...
        <section className="bg-ink py-[140px] px-8 md:px-[52px]">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-20 border-b border-warm-white/[0.07] pb-10 reveal">
            <div>
              <p className="text-[13px] tracking-[0.35em] uppercase text-taupe mb-4">What We Stand For</p>
            ...
            <p className="text-[16px] font-light text-taupe max-w-[380px] leading-[1.8] mt-6 md:mt-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[2px]">
            {pillars.map((p, i) => (
              ...
              >
                ...
                <div className="font-serif text-[13px] tracking-[0.2em] text-taupe mb-7">{p.num}</div>
                <div
                  className="font-serif text-[38px] font-light text-warm-white mb-5 leading-[1.1] [&>em]:italic"
                  dangerouslySetInnerHTML={{ __html: p.title }}
                />
                <p className="text-[17px] font-light leading-[1.85] text-taupe">{p.body}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-cream py-[160px] px-8 md:px-[52px] relative overflow-hidden">
          <div className="absolute top-10 left-9 font-serif text-[282px] md:text-[362px] font-light text-ink/[0.04] leading-none pointer-events-none select-none">
            "
          </div>
          <div className="max-w-[900px] mx-auto text-center relative">
            <p className="text-[13px] tracking-[0.35em] uppercase text-taupe mb-12 reveal">Our Manifesto</p>
            ...
            <div className="w-12 h-px bg-accent mx-auto my-12 reveal" />
            <p className="text-[17px] font-light leading-[1.9] text-taupe max-w-[560px] mx-auto reveal">
        ...
        <div className="bg-accent py-20 px-8 md:px-[52px] grid grid-cols-2 md:grid-cols-4 gap-[2px]">
          {stats.map((s, i) => (
            ...
            >
              <div className="font-serif text-[50px] md:text-[66px] font-light text-warm-white leading-none mb-2">{s.num}</div>
              <div className="text-[13px] tracking-[0.15em] uppercase text-warm-white/[0.65]">{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <section className="bg-background py-[140px] px-8 md:px-[52px] grid grid-cols-1 md:grid-cols-[320px_1fr] gap-16 md:gap-[100px] items-start">
          <div className="reveal">
            <p className="text-[13px] tracking-[0.35em] uppercase text-taupe mb-6">How We Work</p>
          ...
          <div>
            {ethicsItems.map((item, i) => (
              <div key={i} className={`py-10 ${i < ethicsItems.length - 1 ? "border-b border-mist-custom" : ""} ${i === 0 ? "pt-0" : ""} reveal`}>
                ...
                <p className="text-[17px] font-light leading-[1.9] text-taupe">{item.body}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-ink py-[140px] px-8 md:px-[52px] text-center relative overflow-hidden">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-serif text-[202px] md:text-[262px] font-light italic text-warm-white/[0.025] whitespace-nowrap pointer-events-none">
            THINK.
          </div>
          <p className="text-[13px] tracking-[0.35em] uppercase text-taupe mb-8 relative reveal">The Architecture Starts Here</p>
          ...
          <div className="flex justify-center gap-6 items-center relative reveal flex-wrap">
            <Link
              to="/contact"
              className="font-sans text-[13px] tracking-[0.2em] uppercase text-warm-white bg-accent px-10 py-4 no-underline inline-block hover:bg-[#9B8265] hover:-translate-y-0.5 transition-all duration-300"
            >
