        ...
        >
          ...
          {templates && (
            <div style={{ marginTop: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              {templates.length === 0 && (
                <div style={{ color: "hsl(30 10% 70%)", fontSize: 18 }}>No templates found.</div>
              )}
              {templates.map((t) => (
                <div
                  key={t.uuid ?? t.name}
                ...
                >
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <div style={{ color: "hsl(40 20% 97%)", fontSize: 19, marginBottom: 4 }}>
                      {t.name}
                    </div>
                    {t.subject && (
                      <div style={{ color: "hsl(30 10% 70%)", fontSize: 16, marginBottom: 4 }}>
                        {t.subject}
                      </div>
                    )}
                    <code
