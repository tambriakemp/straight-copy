                ...
                return (
                  ...
                  >
                    <div className="roster__client">
                      <div className="roster__name" style={{ fontSize: 20 }}>
                        {inv.contact_name || "—"}
                      </div>
                      <div className="roster__email">{inv.contact_email || "—"}</div>
                      {inv.source_order_id && (
                        <div style={{ fontSize: 13, letterSpacing: "0.2em", textTransform: "uppercase", color: "hsl(30 25% 44%)", marginTop: 4 }}>
                          via SureCart · #{inv.source_order_id.slice(-8)}
                          {inv.tier ? ` · ${inv.tier}` : ""}
                        </div>
                      )}
                    </div>
                    <div className="roster__next" style={{ fontSize: 17 }}>
                      {inv.business_name || "—"}
                    </div>
                    <div>
                      <span style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 14, letterSpacing: "0.2em", textTransform: "uppercase", color: s.tone }}>
