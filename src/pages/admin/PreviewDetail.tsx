    ...
    <Wrap>
      ...
      {!embedded && (
        <div style={{ marginBottom: 14 }}>
          <Link to={backTo ?? "/admin"} style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "var(--crm-taupe)", fontSize: 18, letterSpacing: "0.06em", textTransform: "uppercase" }}>
      ...
      <header style={{ marginBottom: 24, paddingBottom: 20, borderBottom: "1px solid var(--crm-border-dark)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
          <div style={{ minWidth: 0, flex: 1 }}>
            {!embedded && (
              <>
                <div style={{ fontSize: 17, letterSpacing: "0.35em", textTransform: "uppercase", color: "var(--crm-taupe)", marginBottom: 8 }}>
                  Preview Project
                </div>
                <EditableTitle
                  value={project.name}
            ...
            {(project.client_label || project.archived) && (
              <div style={{ marginTop: embedded ? 0 : 10, color: "var(--crm-stone)", fontSize: 19, display: "flex", gap: 16, flexWrap: "wrap" }}>
      ...
      <section style={{ marginBottom: 28, marginTop: isExternal ? 22 : 0 }}>
        {isExternal && (
          <h2 style={{ fontSize: 17, letterSpacing: "0.35em", textTransform: "uppercase", color: "var(--crm-taupe)", margin: "0 0 12px" }}>Uploaded Pages</h2>
        )}
                  ...
                  <div key={f.id} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <InlineRename
                        ...
                        textStyle={{ color: "var(--crm-warm-white)", fontSize: 19, fontWeight: 500 }}
                      />
                    ...
                    {approval && (
                      <span
                        ...
                        style={{
                          ...
                          color: "hsl(140 40% 75%)",
                          fontSize: 15, letterSpacing: "0.08em", textTransform: "uppercase", whiteSpace: "nowrap",
                        }}
                      >
      ...
      <section style={{ marginBottom: 28 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 14, gap: 12, flexWrap: "wrap" }}>
          <h2 style={{ fontSize: 17, letterSpacing: "0.35em", textTransform: "uppercase", color: "var(--crm-taupe)", margin: 0 }}>Upload Files</h2>
        ...
        <h2 style={{ fontSize: 17, letterSpacing: "0.35em", textTransform: "uppercase", color: "var(--crm-taupe)", margin: "0 0 14px" }}>Assets & Missing References</h2>
        ...
        {assets.length > 0 && (
          <div>
            ...
            >
              ...
              <span style={{ fontSize: 19 }}>Assets ({assets.length})</span>
              <span style={{ marginLeft: "auto", color: "var(--crm-taupe)", fontSize: 17 }}>
            ...
            {assetsOpen && (
              <ul style={{ marginTop: 8, listStyle: "none", padding: 0, display: "grid", gap: 4, maxHeight: 320, overflowY: "auto" }}>
                {assets.map((f) => {
                  ...
                  return (
                    <li key={f.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 12px", fontSize: 18, color: "var(--crm-stone)", borderRadius: 6 }}>
        ...
        {missing.length > 0 && (
          <div style={{ marginTop: 14, padding: "12px 14px", background: "hsl(30 60% 50% / 0.08)", border: "1px solid hsl(30 60% 50% / 0.3)", borderRadius: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, color: "hsl(30 80% 70%)", fontSize: 18, fontWeight: 600, marginBottom: 8 }}>
              <AlertTriangle size={14} /> {missing.length} missing asset reference{missing.length > 1 ? "s" : ""}
            </div>
            <div style={{ fontSize: 17, color: "var(--crm-stone)", marginBottom: 8 }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "grid", gap: 6, maxHeight: 280, overflowY: "auto" }}>
              {missing.slice(0, 50).map((m, i) => {
                ...
                return (
                  <li key={i} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 17, fontFamily: "monospace", color: "var(--crm-stone)", flexWrap: "wrap" }}>
                    ...
                    <select
                      ...
                      style={{ fontSize: 17, padding: "4px 6px", marginLeft: "auto", maxWidth: 280 }}
                    >
              ...
              {missing.length > 50 && <li style={{ fontSize: 17, color: "var(--crm-taupe)" }}>+{missing.length - 50} more…</li>}
            </ul>
          </div>
        )}
      </section>
      ...
      <section>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 14, gap: 12, flexWrap: "wrap" }}>
          <h2 style={{ fontSize: 17, letterSpacing: "0.35em", textTransform: "uppercase", color: "var(--crm-taupe)", margin: 0 }}>
            Feedback Board
          </h2>
          {distinctPages.length > 1 && (
            <select
              ...
              style={{ width: 240, fontSize: 18, padding: "6px 10px" }}
            >
        ...
        {comments.length === 0 ? (
          <div style={{ padding: 32, textAlign: "center", color: "var(--crm-taupe)", border: "1px dashed var(--crm-border-dark)", borderRadius: 10, fontSize: 19 }}>
            ...
            {COLUMNS.map((col) => (
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                  <span style={{ fontSize: 16, letterSpacing: "0.3em", textTransform: "uppercase", color: "var(--crm-warm-white)" }}>{col.title}</span>
                  <span style={{ fontSize: 17, color: "var(--crm-taupe)" }}>{cardsByStatus[col.key].length}</span>
                </div>
                <div style={{ display: "grid", gap: 8 }}>
                    ...
                    return (
                      ...
                      >
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                          <span style={{ fontSize: 16, color: "var(--crm-accent)", fontWeight: 600, letterSpacing: "0.05em" }}>#{c.pin_number}</span>
                          <span style={{ fontSize: 16, color: "var(--crm-taupe)" }}>{timeAgo(c.created_at)}</span>
                        </div>
                        <div style={{ fontSize: 18, color: "var(--crm-warm-white)", lineHeight: 1.4, display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
                          {c.body}
                        </div>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 8, fontSize: 16, color: "var(--crm-taupe)" }}>
                  ...
                  {cardsByStatus[col.key].length === 0 && (
                    <div style={{ fontSize: 17, color: "var(--crm-taupe)", textAlign: "center", padding: "20px 0" }}>—</div>
                  )}
                </div>
              </div>
            ))}
        ...
        >
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                <div style={{ fontSize: 16, letterSpacing: "0.3em", textTransform: "uppercase", color: "var(--crm-accent)" }}>
                  Pin #{activeComment.pin_number}
                </div>
                <div style={{ fontSize: 17, color: "var(--crm-taupe)", marginTop: 2 }}>
            ...
            <div style={{ background: "hsl(40 20% 97% / 0.04)", borderRadius: 8, padding: 14, fontSize: 20, color: "var(--crm-warm-white)", whiteSpace: "pre-wrap", lineHeight: 1.5 }}>
              {activeComment.body}
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {(repliesByComment[activeComment.id] || []).map((r) => (
                <div key={r.id} style={{
                  padding: "10px 12px", borderRadius: 8, fontSize: 19,
                  background: r.is_admin ? "var(--crm-accent)" : "hsl(40 20% 97% / 0.06)",
                  color: r.is_admin ? "var(--crm-warm-white)" : "var(--crm-stone)",
                }}>
                  <div style={{ fontSize: 16, opacity: 0.75, marginBottom: 4, textTransform: "uppercase", letterSpacing: "0.1em" }}>
      ...
      <Dialog open={pickerOpen} onOpenChange={setPickerOpen}>
        <DialogContent className="crm-shell !bg-[hsl(36_5%_16%)] !border-[hsl(40_20%_97%/0.08)] !text-[hsl(40_20%_97%)] !rounded-none !max-w-lg">
          ...
          <div className="space-y-3 mt-2">
            ...
            {pickerLoading ? (
              <div style={{ fontSize: 16, padding: "12px 0" }}>Loading contacts…</div>
            ) : pickerContacts.length === 0 ? (
              <div style={{ fontSize: 16, color: "var(--crm-taupe)", fontStyle: "italic", padding: "12px 0" }}>
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 17 }}>
                        ...
                        {c.is_primary && (
                          <span style={{ fontSize: 12, letterSpacing: "0.2em", textTransform: "uppercase", color: "hsl(40 30% 70%)" }}>
                            Primary
                          </span>
                        )}
                        {c.role && (
                          <span style={{ fontSize: 13, color: "var(--crm-taupe)" }}>· {c.role}</span>
                        )}
                      </div>
                      <div style={{ fontSize: 15, color: "var(--crm-taupe)", marginTop: 2 }}>{c.email}</div>
                    </div>
                  </label>
                ))}
              </div>
...
function EditableTitle({ value, onSave }: { value: string; onSave: (next: string) => Promise<void> }) {
    ...
    return (
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <input
          ...
          style={{ flex: 1, fontFamily: "var(--crm-font-serif)", fontWeight: 300, fontSize: 36, lineHeight: 1.1, color: "var(--crm-warm-white)", background: "transparent", border: "1px solid var(--crm-border-dark)", borderRadius: 6, padding: "4px 10px" }}
        />
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      <h1 style={{ fontFamily: "var(--crm-font-serif)", fontWeight: 300, fontSize: 42, lineHeight: 1.1, color: "var(--crm-warm-white)", margin: 0 }}>
        {value}
      </h1>
    ...
    return (
      <span style={{ display: "inline-flex", alignItems: "center", gap: 6, width: "100%" }}>
        <input
          ...
          style={{ flex: 1, minWidth: 0, fontSize: 18, color: "var(--crm-warm-white)", background: "transparent", border: "1px solid var(--crm-border-dark)", borderRadius: 4, padding: "2px 6px" }}
        />
        ...
        return (
          ...
          >
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: 18, color: "var(--crm-warm-white)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                <span style={{ color: "var(--crm-taupe)", marginRight: 8, fontSize: 15, letterSpacing: "0.14em", textTransform: "uppercase" }}>{e.kind}</span>
                {e.path}
              </div>
              <div style={{ fontSize: 16, color: "var(--crm-stone)", marginTop: 3 }}>
                {e.approver_name ? `by ${e.approver_name}` : "by anonymous client"}
              </div>
            </div>
            <div style={{ fontSize: 16, color: "var(--crm-taupe)", whiteSpace: "nowrap" }}>{fmt(e.created_at)}</div>
          </div>
        );
      })}
    </div>
  ...
  return (
    <section style={{ marginBottom: 28 }}>
      <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 14, flexWrap: "wrap" }}>
        <div style={{ flex: 1, fontSize: 17, color: "var(--crm-taupe)" }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      {Object.entries(grouped).map(([p, list]) => (
        <div key={p} style={{ border: "1px solid var(--crm-border-dark)", borderRadius: 10, padding: 14, background: "hsl(40 20% 97% / 0.03)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
            <div>
              <div style={{ fontSize: 17, color: "var(--crm-warm-white)", fontWeight: 600 }}>{labelFor(p)}</div>
              <div style={{ fontSize: 16, color: "var(--crm-taupe)", fontFamily: "monospace" }}>{p}</div>
            </div>
            {baseUrl && (
            ...
            {list.map((c) => (
              <div key={c.id} style={{ padding: "10px 12px", borderRadius: 8, background: "hsl(40 20% 97% / 0.04)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", gap: 8, marginBottom: 4 }}>
                  <span style={{ fontSize: 16, color: "var(--crm-stone)" }}>{c.author_name || "Guest"} · {new Date(c.created_at).toLocaleString()}</span>
                ...
                <div style={{ fontSize: 18, color: "var(--crm-warm-white)", whiteSpace: "pre-wrap" }}>{c.body}</div>
              </div>
            ))}
          </div>
        </div>
  ...
  return (
    <section style={{ marginBottom: 22, padding: "16px 18px", border: "1px solid var(--crm-border-dark)", borderRadius: 10, background: "hsl(40 20% 97% / 0.03)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 12, marginBottom: 10, flexWrap: "wrap" }}>
        ...
        <span style={{ fontSize: 16, color: "var(--crm-taupe)" }}>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        <input
          ...
          disabled={saving}
          style={{ flex: "1 1 320px", background: "transparent", border: "1px solid var(--crm-border-dark)", borderRadius: 6, padding: "8px 12px", color: "var(--crm-warm-white)", fontSize: 18 }}
        />
