      ...
      <div className="roster">
                ...
                <div className="space-y-4 mt-2">
                  ...
                  {sourceType === "external_url" && (
                    <div>
                      ...
                      <div style={{ fontSize: 16, color: "var(--crm-taupe)", marginTop: 6 }}>
        ...
        {loading ? (
          ...
          <div style={{ padding: "60px 0", color: "var(--crm-taupe)", textAlign: "center", border: "1px dashed var(--crm-border-dark)", borderRadius: 12 }}>
            <div style={{ fontSize: 17, letterSpacing: "0.3em", textTransform: "uppercase", marginBottom: 8 }}>No previews</div>
            <div style={{ fontSize: 20 }}>Create your first preview project above.</div>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                    <span style={{ fontSize: 16, letterSpacing: "0.3em", textTransform: "uppercase", color: p.archived ? "hsl(0 50% 65%)" : "var(--crm-accent)" }}>
                      {p.archived ? "Archived" : p.feedback_enabled ? "Live" : "Feedback off"}
                    </span>
                    <span style={{ fontSize: 17, color: "var(--crm-taupe)" }}>{new Date(p.created_at).toLocaleDateString()}</span>
                  </div>
                  <div>
                    <h3 style={{ fontFamily: "var(--crm-font-serif)", fontWeight: 300, fontSize: 30, color: "var(--crm-warm-white)", margin: 0, lineHeight: 1.2 }}>
                      {p.name}
                    </h3>
                    {p.client_label && (
                      <div style={{ marginTop: 6, fontSize: 18, color: "var(--crm-stone)" }}>{p.client_label}</div>
                    )}
                  </div>
