            ...
            <div className="ob-scroll overflow-y-auto h-full px-8 md:px-20 py-16">
              ...
              {(() => {
                ...
                const rows: Array<[string, string]> = [
                  ...
                  ["One-liner", fmt(summary.business_one_liner)],
                  ["Primary offer", fmt(summary.primary_offer)],
                  ["Price point", fmt(summary.price_point)],
                  ["Lead magnet", fmt(summary.lead_magnet)],
                  ["Landing page CTA", fmt(summary.landing_page_cta)],
                  ...
                  ["Content topics", fmt(summary.content_topics)],
                  ["Posting goal", fmt(summary.posting_goal)],
