...
const services = [
  ...
  },
  {
    ...
    desc: "A brand that looks like it belongs in Vogue. We design visual identity systems built for the long run — wordmarks, color systems, typography pairings, and brand guidelines that keep everything cohesive across every touchpoint.",
    includes: [
      "Primary logo + variations (stacked, horizontal, icon)",
      "Color palette & typography system",
      "Brand guidelines document",
      "Business card, letterhead & digital asset templates",
  ...
  },
  {
    ...
    tags: ["WordPress", "Elementor", "E-Commerce", "Custom"],
    desc: "Websites that convert — built with the same editorial eye as our campaigns. We specialize in WordPress and Elementor builds that are fast, beautiful, and designed to grow with your brand. From landing pages to full e-commerce stores.",
    includes: [
      "Custom WordPress + Elementor design & build",
...
const pricing = [
  {
    ...
    items: ["10 AI campaign images", "2 creative concepts", "1 round of revisions", "All formats delivered", "5-day turnaround"],
    featured: false,
  ...
  },
  {
    ...
    items: ["30 AI campaign images", "Full creative direction", "3 concept directions", "Unlimited revisions", "Priority 3-day turnaround", "Social content batch included"],
    featured: true,
  ...
  },
  {
    ...
    items: ["Unlimited monthly imagery", "Dedicated creative team", "Brand style system maintained", "Weekly content drops", "Web updates included", "Custom SLA & delivery"],
    featured: false,
